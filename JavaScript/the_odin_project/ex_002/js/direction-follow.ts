...
const direction_button = document.querySelector(".direction_button");
direction_button?.addEventListener("click", main);
...
function main() {
    ...
    let greeting = `Hello! My name is ${full_name} and i'm ${age} years old.`;
