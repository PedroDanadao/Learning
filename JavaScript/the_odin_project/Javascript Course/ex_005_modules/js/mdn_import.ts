...
import { export_1, export_2 } from "./mdn_imports_source.js";
console.log(export_1);

import { export_1, export_2 as alias_3 } from "./mdn_imports_source.js";
console.log(alias_3);

import {"string name" as alias_4} from "./mdn_imports_source.js";
console.log(alias_4);

// import default_export, {export_1, export_2} from "./mdn_imports_source";

import default_export, * as name2 from "./mdn_imports_source.js";
